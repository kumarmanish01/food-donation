...
<html>
<head>
<title>Food Donation System|||Home Page</title>
				...
				<ul class="rslides" id="slider3">
					<li>
						<div class="banner-info">
							...
							<p>If you want your checkbook to follow your heart, make a donation
								to those who are not able to help themselves. 
							</p>
					...
					<li>
						<div class="banner-info">
							...
							<p>We are a country that prides itself on power and wealth, 
							...
							to get involved. So, next time you pass someone on the street who is in need, 
							remember how lucky you are, and do not turn away. </p>
							<a href="about.php" class="hvr-rectangle-out button">READ MORE</a>
						</div>
						<div class="clearfix"></div>
					</li>
				...
				<div class="mis-one">
					...
					<div class="mis-right">
						...
						<p>We are a country that prides itself on power and wealth, 
							...
							It is our responsibility, not only as a nation, but also as individuals, 
							to get involved. So, next time you pass someone on the street who is in need, 
							remember how lucky you are, and do not turn away.
						</p>
					</div>
					<div class="clearfix"></div>
				</div>
