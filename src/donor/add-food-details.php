...
$fitemarray=implode(",",$fitem);
    $query=mysqli_query($con, "insert into tblfood(DonorID,foodId,StateName, CityName, PinCode, FoodItems, Description, PickupDate,PickupAddress,ContactPerson,CPMobNumber,Image) value('$donorid','$fid','$statename','$cityname', '$pincode' ,'$fitemarray','$description','$pdate','$padd','$contactperson','$cpmobnum','$foodpic')");
...
<!DOCTYPE html>
<head>
<title>Food Donation System  | Add Food Detail </title>
...
<tr>
<td><input type="text" name="fitem[]" placeholder="Enter Food Items" class="form-control name_list" pattern = "[a-zA-Z'-'\s]*" title = "Alphabets only"/></td>
<td><button type="button" name="add" id="add" class="btn btn-success">Add More</button></td>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" id="pincode" name="pincode" type="text" required="true" value="" pattern = "[0-9]{6}" title = "Pin must be only of 6 digits">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Contact Person</label>
                        <div class="col-sm-6">
                            <input class="form-control" id="contactperson" name="contactperson" type="text" required="true" value="" pattern = "[a-zA-Z'-'\s]*" title = "Name must be Alphabets only">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Contact Person Mobile Number</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="cpmobnum" id="cpmobnum" required="true" value="" maxlength="10" pattern="[0-9]{10}" title = "Must be numeric of 10 digits">
                        </div>
                    </div>
