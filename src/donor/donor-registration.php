...
<!DOCTYPE html>
<head>
<title>FDS | Donor Registration </title>
...
<div class="w3layouts-main">
    ...
    echo $msg;
		...
		<form action="#" method="post">
			<input type="text" class="ggg" name="name" placeholder="NAME" required="true" pattern = "[a-zA-Z'-'\s]*" title = "Alphabets only">
			<input type="email" class="ggg" name="email" placeholder="E-MAIL" required="true">
			<input type="text" class="ggg" name="mobilnumber" placeholder="PHONE" required="true" maxlength="10" pattern="[0-9]{10}" title = "Must be numeric of 10 digits">
			<input type="password" class="ggg" name="password" placeholder="PASSWORD" required="true" id="txtPassword">
			<input type="password" class="ggg" name="repeatpassword" placeholder="REPEAT PASSWORD" required="true" id="txtConfirmPassword">
