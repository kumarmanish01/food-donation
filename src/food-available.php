...
$state=$_POST['state'];
$city=$_POST['city'];
$ret=mysqli_query($con,"select * from  tblfood where StateName = '$state' and CityName = '$city' order by CreationDate desc");
$cnt=1;
            ...
            <td><?php echo $cnt;?></td>
              ...
              <td><?php  echo $row['FoodItems'];?></td>
               <td><?php  echo $row['PickupAddress'];?></td>
                  ...
                  <td id="viewBtnCell"><a id="viewBtn" href="view-food-details.php?foodid=<?php echo $row['ID'];?>">View Details </a>
                </tr>
               <?php 
$cnt=$cnt+1;
}} else {?>
