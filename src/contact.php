...
<html>
<head>
<title>Food Donation System| Contact Us</title>
...
<div class="contact">
	<div class="container">
		...
		<div class="contact-gds">
			...
			<div class="col-md-6 contact-top text-height-2">
				<h3 class="info"> Contact Us</h3>
				<p>
					<b>Food for All</b>
					<div><b>Contact Number:</b> +91-96784532145</div>
					<div><b>email: </b> food4all@gmail.com</div>
					<div><b>Address : </b> YCM Chowk Sant-Tukaram Nagar Pimpri Pune</div>
				</p>
			</div>
		</div>
		</div>
