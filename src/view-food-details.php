...
$query=mysqli_query($con,"insert into tblfoodrequests(foodId,organizationName, fullName,mobileNumber,message,requestNumber) values('$foodid', '$organisationName','$fname','$mnumber','$msg','$reqnumber')");
...
<script type="text/javascript">
    ...
    //     let organisationType = document.getElementById("organisationType");
    //     let organizationName = document.getElementById("organisationName");
    //     // dvPassport.style.display = ddlPassport.value == "Y" ? "block" : "none";
    //     if(organisationType.value == "ngo" || organisationType.value == "orphanage"){
    ...
    $(function () {
        $("#organisationType").change(function () {
            if ($(this).val() == "ngo" || $(this).val() == "orphanage") {
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p><input type="text" class="form-control" name="organisationName" placeholder="Organisation Name" pattern = "[a-zA-Z'-'\s]*" title = "Alphabets only" required></p>
        <p style="margin-top:1%"><input type="text" class="form-control" name="name" placeholder="Contact Person Name" pattern = "[a-zA-Z'-'\s]*" title = "Alphabets only" required></p>
        ...
        <p style="margin-top:1%;"><textarea name="message" class="form-control" placeholder="Message if any" pattern = "[a-zA-Z'-'\s]*" title = "Alphabets only"></textarea></p>
